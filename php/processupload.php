...
$destination_folder		= 'upload/'; //upload directory ends with / (slash)
...
//			echo '<img src="/php/upload/'.$thumb_prefix . $new_file_name.'" alt="Thumbnail">';
//			echo '<br />';
//			echo '<img src="/php/upload/'. $new_file_name.'" alt="Resized Image">';
//			echo '</div>';
                        
                        //die('Tu imagen fue guardada existosamente');
                        //$queryInserta
                        $id = $_POST['id_oferta'];
                        $rutaArchivo = "/php/" . $thumb_save_folder;
                        $queryImagenOferta = "UPDATE ac_ofertas SET oferta_imagen = '$rutaArchivo' WHERE oferta_id = $id";
                        $con->query($queryImagenOferta);
